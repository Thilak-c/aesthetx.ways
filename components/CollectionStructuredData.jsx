...
export function CollectionStructuredData({ collectionName, products, description }) {
  ...
  const structuredData = {
    ...
    description: description || `Shop our ${collectionName} collection featuring premium fashion products.`,
    url: `https://aesthetxways.com/collections/${collectionName.toLowerCase().replace(/\s+/g, '-')}`,
    mainEntity: {
      "@type": "ItemList",
