...
const menCards = [
  { name: "New Arrivals", img: "/banner/hoodies_1.PNG" },
  { name: "Best Sellers", img: "/banner/tees_2.PNG" },
  { name: "Sale", img: "/banner/Jerseys_1.PNG" },
];
const categories = ["All Accessories", "Clothing", "Shoes", "Beauty"];
const accessories = [
  { name: "Sunglasses", img: "/favicon.ico" },
  { name: "Watches", img: "/favicon.ico" },
  { name: "Bags", img: "/favicon.ico" },
];
