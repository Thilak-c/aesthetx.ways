...
const STORES = [
  {
    id: 'patna',
    name: 'AesthetXways Patna Flagship',
    type: 'Concept Drop-Center & HQ',
    address: 'Grand Chandra, Fraser Road Area,\nPatna, Bihar 800001',
    phone: '+91 91539 90059',
    rating: '4.9',
    reviewsCount: '284',
    coordinates: '25.6121° N, 85.1376° E',
    transitInfo: '5 mins from Patna Junction (PTJR)',
    hours: [
      ...
      { day: 'Friday', time: '10:30 AM - 11:30 PM' },
      { day: 'Saturday', time: '10:30 AM - 11:30 PM' },
      { day: 'Sunday', time: '10:30 AM - 11:00 PM' }
    ],
    directionsUrl: 'https://maps.google.com/?q=Grand+Chandra+Fraser+Road+Patna'
  },
  {
    id: 'gaya',
    name: 'AesthetXways Gaya Store',
    type: 'Express Retail Hub',
    address: 'G.B. Road, Near Tower Chowk,\nGaya, Bihar 823001',
    phone: '+91 91539 90060',
    rating: '4.8',
    reviewsCount: '196',
    coordinates: '24.7955° N, 84.9974° E',
    transitInfo: '8 mins from Gaya Junction (GAYA)',
    hours: [
    ...
    directionsUrl: 'https://maps.google.com/?q=GB+Road+Gaya'
  }
];
  ...
  return (
    <div className="flex flex-col flex-1 bg-white relative pb-20 min-h-[90vh]">
      ...
      <main className="flex-1 px-4 py-6 overflow-y-auto">
        ...
        {/* Title Section */}
        <div className="mb-6">
          <h1 className="font-lovelo-black text-xl tracking-widest text-zinc-900 leading-none">
            AesthetXways Stores
          </h1>
        ...
        <div className="flex bg-zinc-100 p-0.5 rounded-[3px] border border-zinc-200/40 shadow-inner w-full mb-6">
          {STORES.map((store) => (
            <button
              ...
              className={`flex-1 text-center py-2.5 text-[9px] tracking-widest uppercase font-bold transition-all duration-200 rounded-[2px] cursor-pointer ${
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="border border-zinc-100 bg-zinc-50/50 rounded-[2px] p-4 flex flex-col gap-3">
            <div className="flex justify-between items-start border-b border-zinc-100 pb-2">
              ...
              <span className={`text-[7.5px] tracking-wider uppercase font-bold px-2 py-0.5 rounded-[1px] ${
                isOpenNow ? 'bg-emerald-50 text-emerald-700 border border-emerald-100' : 'bg-rose-50 text-rose-700 border border-rose-100'
              }`}>
