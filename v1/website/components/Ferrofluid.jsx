...
const Ferrofluid = ({
  ...
  useEffect(() => {
    ...
    // Check if WebGL is available before attempting renderer creation
    const testCanvas = document.createElement('canvas');
    const testGl = testCanvas.getContext('webgl') || testCanvas.getContext('experimental-webgl');
    if (!testGl) {
      console.warn('Ferrofluid: WebGL not supported on this device, skipping.');
      return;
    }
    ...
    try {
      ...
      console.warn('Ferrofluid: Failed to create renderer, skipping.', e);
      return;
    }
