            ...
            <div ref={printRef} className="p-8 bg-white">
              ...
              <div className="text-center pb-6 mb-6 border-b-2 border-gray-900">
                <div className="flex justify-center mb-3">
                  <img src={logoBase64 || "/logo.png"} alt="Aesthetx Ways" className="h-10 w-auto max-w-[120px] object-contain" />
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-dashed border-gray-300 text-center">
                ...
                <div className="mt-6 pt-4 border-t border-gray-200">
                  <p className="text-[10px] text-gray-400">Follow us @aesthetxways.com</p>
                </div>
              </div>
            </div>
